...
public class PicBox2 : Control
{
    ...
    private Size GetSizeFromAlternativeSources()
    {
        ...
        if (vm.NavigationViewModel.ActiveTab.Value.CurrentModel.CurrentValue.FileInfo?.Exists != true)
        {
            return new Size();
        }
        ...
        try
        {
            ...
            magickImage.Ping(vm.NavigationViewModel.ActiveTab.Value.CurrentModel.Value.FileInfo);
