...
/// </summary>
public static class ClipboardFileOperations2
{
    /// <summary>
    ...
    public static async Task Duplicate(string? path, MainWindowViewModel vm)
    {
        ...
        {
            DebugHelper.LogDebug(nameof(ClipboardFileOperations2), nameof(Duplicate), ex);
    ...
    private static async Task DuplicateCurrentFile(MainWindowViewModel vm)
    {
        ...
        {
            DebugHelper.LogDebug(nameof(ClipboardFileOperations2), nameof(DuplicateCurrentFile), ex);
        }
    }
    ...
    public static async Task CopyFileToClipboard(string? filePath, Visual? visual = null)
    {
        ...
        var clipboard = ClipboardService2.GetClipboard(visual);
        if (clipboard == null)
        {
            return;
        }
